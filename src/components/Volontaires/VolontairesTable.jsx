...
const VolontairesTable = ({ volontaires, onArchive }) => {
  // État pour le tri
              ...
              sortedVolontaires.map((volontaire, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    <a href={`mailto:${volontaire.emailVol || volontaire.email}`} className="text-blue-600 hover:text-blue-900">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end space-x-2">
                      <Link
                        to={`/volontaires/${volontaire.id || volontaire.volontaireId}/edit`}
                      ...
                      <Link
                        to={`/volontaires/${volontaire.id || volontaire.volontaireId}`}
                        className="text-gray-600 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 py-1 px-3 rounded-md transition-colors duration-150"
                      >
                        Détails
                      </Link>
                      {!volontaire.archive ? (
                        <button
                          onClick={() => onArchive(volontaire.id || volontaire.volontaireId)}
